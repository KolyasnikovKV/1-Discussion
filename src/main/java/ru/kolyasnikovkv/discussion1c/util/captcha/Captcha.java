package ru.kolyasnikovkv.discussion1c.util.captcha;

import java.awt.*;
import java.io.OutputStream;

import static ru.kolyasnikovkv.discussion1c.util.captcha.Randoms.alpha;
import static ru.kolyasnikovkv.discussion1c.util.captcha.Randoms.num;
