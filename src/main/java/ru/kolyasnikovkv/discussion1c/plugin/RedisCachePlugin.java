...
public class RedisCachePlugin {
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.TopicServiceHook.selectById()")
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.TopicServiceHook.updateViewCount()")
    ...
    @After("ru.kolyasnikovkv.discussion1c.hook.TopicServiceHook.update()")
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.CommentServiceHook.selectByTopicId()")
    ...
    @After("ru.kolyasnikovkv.discussion1c.hook.CommentServiceHook.insert()")
    ...
    @After("ru.kolyasnikovkv.discussion1c.hook.CommentServiceHook.update()")
    public void commentUpdate(JoinPoint joinPoint) {
        Comment comment = (Comment) joinPoint.getArgs()[0];
        redisService.delString(String.format(RedisKeys.REDIS_COMMENTS_KEY, comment.getTopicId()));
    }

    @After("ru.kolyasnikovkv.discussion1c.hook.CommentServiceHook.delete()")
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.UserServiceHook.selectByUsername()")
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.UserServiceHook.selectByEmail()")
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.UserServiceHook.selectByMobile()")
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.UserServiceHook.selectByToken()")
    ...
    @Around("ru.kolyasnikovkv.discussion1c.hook.UserServiceHook.selectById()")
    ...
    @After("ru.kolyasnikovkv.discussion1c.hook.UserServiceHook.delRedisUser()")
